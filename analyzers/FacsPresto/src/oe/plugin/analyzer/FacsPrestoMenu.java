...
public class FacsPrestoMenu extends MenuPlugin {
	...
	protected void insertMenu() {
        ...
        service.insertLanguageKeyValue("banner.menu.results.FacsPrestoanalyzer","Immunology: FacsPresto", Locale.ENGLISH.toLanguageTag());
		//Analyzer name in French
        service.insertLanguageKeyValue("banner.menu.results.FacsPrestoanalyzer","Immunologie: FacsPresto", Locale.FRENCH.toLanguageTag());
	}
